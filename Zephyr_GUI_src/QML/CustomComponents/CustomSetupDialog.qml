...
Dialog{
    ...
    onOpened: {
        appCore.setTempValueObj(parameterButtons.checkedButton.index)
    ...
    ButtonGroup{
        ...
        onCheckedButtonChanged: {
            if (checkedButton == targetButton)
            {
                valueSlider.value = appCore.valueModel.getLast().target
                valueDiaplay.text = appCore.valueModel.getLast().target
            }
            else if (checkedButton == minButton)
            {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                Button { // target
                    ...
                    text: isOpen?  "Target: " + appCore.valueModel.getLast().target + " "+ appCore.valueModel.getLast().unit : ""
                }
                Button { // min
                    id: minButton
                    Layout.fillHeight: true
            ...
            ColumnLayout {
                ...
                Label {
                    ...
                    text: {
                        ...
                        if (settableButtons.checkedButton == targetButton)
                            appCore.valueModel.getLast().target
                        else if (settableButtons.checkedButton == minButton)
                ...
                RowLayout {
                    ...
                    Button {
                        ...
                        onClicked: {
                            ...
                            if (settableButtons.checkedButton == targetButton)
                            {
                                if (appCore.valueModel.getLast().target > appCore.valueModel.getLast().lowerLimit)
                                    appCore.updateTempTarget(appCore.valueModel.getLast().target -1)
                                valueSlider.value = appCore.valueModel.getLast().target
                                valueDiaplay.text = appCore.valueModel.getLast().target
                            }
                            else if (settableButtons.checkedButton == minButton)
                    ...
                    Button {
                        ...
                        onClicked: {
                            if (settableButtons.checkedButton == targetButton)
                            {
                                if (appCore.valueModel.getLast().target < appCore.valueModel.getLast().upperLimit)
                                    appCore.updateTempTarget(appCore.valueModel.getLast().target +1)
                                valueSlider.value = appCore.valueModel.getLast().target
                                valueDiaplay.text = appCore.valueModel.getLast().target
                            }
                ...
                Slider {
                    ...
                    onValueChanged: {
                        if (settableButtons.checkedButton == targetButton)
                        {
                            appCore.updateTempTarget(value)
                            valueDiaplay.text = appCore.valueModel.getLast().target
                        }
                        else if (settableButtons.checkedButton == minButton)
                        {
        ...
        Item {
            ...
            Button {
                ...
                onClicked: {
                    ...
                    parameterButtons.checkState = Qt.Unchecked
            ...
            Button {
                ...
                onClicked: {
                    dialog.close()
                    appCore.saveTempValues(parameterButtons.checkedButton.index)
                    parameterButtons.checkState = Qt.Unchecked
                    settableButtons.checkState = Qt.Unchecked
                }
            }
